...
For a direct access to this Shiny application, click [here](https://www.shinyapps.io/admin/#/dashboard)
...
Option 1: Direct link: click [here](https://www.shinyapps.io/admin/#/dashboard)
